...
var rem = [];
var statusvar=0;
var ListItem = createReactClass({ displayName: "ListItem",
...
var Table = createReactClass({ displayName: "Table",
  getInitialState: function () {
  ...
  render: function () {
    return (
      ...
      React.createElement("td", { className: "totalTR" }, "Tasks Remaining :  "+ (alltasks.length-statusvar))
      ))));
...
var AddNewRow = createReactClass({ displayName: "AddNewRow",
  render: function () {
    return (
      React.createElement("div", null,
  ...
  var RemoveRow = createReactClass({ displayName: "AddNewRow",
    render: function () {
      return (
        React.createElement("div", null,
...
var Initiator = createReactClass({ displayName: "Initiator",
  getInitialState: function () {
    return {
